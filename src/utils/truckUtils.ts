...
export const getTruckIcon = (id: string) => {
  switch(id) {
    case "refrigerated": return "/lovable-uploads/dad6802a-4aea-43eb-9b55-7eeae82566c1.png"; // Now using the wheel excavator icon for refrigerated
    ...
    case "wheel-excavator": return "/lovable-uploads/cc1d2b91-8416-4580-9616-be1490769ef3.png"; // Now using refrigerated icon for wheel excavator (swapped)
